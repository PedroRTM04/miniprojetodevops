...
public class ModerateLoadSimulation extends Simulation {
    ...
    ScenarioBuilder moderateLoad = scenario("Moderate Load Scenario")
        .exec(getWeatherRequest);

    {
        setUp(
            moderateLoad.injectOpen(constantUsersPerSec(50).during(30))  // 50 req/s por 30 segundos
